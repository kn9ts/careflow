...
test.describe("Dialer Tab", () => {
  ...
  test("should toggle call mode (Twilio/WebRTC)", async ({ page }) => {
    ...
    const initialMode = await page
      .locator('[data-testid="call-mode-indicator"]')
      .textContent();
...
test.describe("Call History Tab", () => {
  ...
  test("should display call history list", async ({ page }) => {
    await expect(
      page.locator('[data-testid="call-history-list"]'),
    ).toBeVisible();
  });
...
test.describe("Recordings Tab", () => {
  ...
  test("should play recording", async ({ page }) => {
    const firstRecording = page
      .locator('[data-testid="recording-item"]')
      .first();
...
test.describe("Analytics Tab", () => {
  ...
  test("should display analytics dashboard", async ({ page }) => {
    await expect(
      page.locator('[data-testid="analytics-container"]'),
    ).toBeVisible();
  });
  ...
  test("should show call statistics", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="total-calls-stat"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="total-duration-stat"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="average-duration-stat"]'),
    ).toBeVisible();
  });
  ...
  test("should refresh analytics data", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="analytics-loading"]'),
    ).toBeVisible();
...
test.describe("Call Controls", () => {
  ...
  test("should toggle mute state", async ({ page }) => {
    ...
    // Verify muted state
    await expect(page.locator('[data-testid="mute-button"]')).toHaveAttribute(
      "data-muted",
      "true",
    );
  });

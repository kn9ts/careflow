...
describe('Dashboard Components', () => {
  ...
  describe('Call History', () => {
    ...
    test('should sort call history by date descending', () => {
      ...
      callHistory.sort((a, b) => b.date - a.date);
    ...
    test('should filter call history by type', () => {
      ...
      const inboundCalls = callHistory.filter((call) => call.type === 'inbound');
      const outboundCalls = callHistory.filter((call) => call.type === 'outbound');
